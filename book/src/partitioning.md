...
The library uses partitioning of tensor networks to parallelize the contraction.
...
This will use the Hypergraph partitioner KaHyPar to find roughly equally sized partitions with minimal cost for the legs between the partitions.

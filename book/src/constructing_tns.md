...
### Sycamore circuit
There are special methods to construct tensor networks corresponding to the quantum circuits of the Sycamore experiment ([Quantum supremacy using a programmable superconducting processor](https://www.nature.com/articles/s41586-019-1666-5) (Arute et al.)). See the [`sycamore_circuit`] method.
